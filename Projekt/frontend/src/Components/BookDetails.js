...
const BookDetails = ({ksiazki, DodajUlubione, UsunUlubione, Ulubione, setAdd, setSearch, setDoUsuniecia}) => {
    ...
    useEffect(()=>{
        setKsiazka(ksiazki.find(a => a._id === Id))  
    },[Id, ksiazki]);
    ...
    return (
        <div className='container book2'>
            <div className='col1'>
                ...
                <Rating Rating={Ksiazka.rating_sum/Ksiazka.rating_count} Id={Id} />
            ...
            <div className='buttons'>
                ...
                { !Ulubione.includes(Ksiazka._id) && <button className='fav' onClick={() => DodajUlubione(Ksiazka._id)} > Ulubione </button>}
                { Ulubione.includes(Ksiazka._id) && <button className='fav2' onClick={() => UsunUlubione(Ksiazka._id)} > Ulubione </button>} 
            </div>
            <h1> {Ksiazka.title} </h1>
