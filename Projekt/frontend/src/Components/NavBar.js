...
const NavBar = ({onDelete, onAdd, onSearch, ChangeSort, setAdd, setSearch, onLogin, onLogout, Login}) => {
    ...
    return (
        <ul className='nav-bar'>
            ...
            <div className='el' >
                ...
                {!Login && <li className='nav-bar-right'><button className='nav-element' onClick={onLogin}> Login </button></li>}
                {Login && <li className='nav-bar-right'><button className='nav-element' onClick={onLogout}> Logout </button></li>}
